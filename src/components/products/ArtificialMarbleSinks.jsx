...
import "./CeramicPorcelen.css"; // استخدم نفس CSS

export default function ArtificialMarbleSinks() {
  const PAGE_NAME = "رخام صناعي ومغاسل";
  ...
  const products = useMemo(
    () => [
      {
        id: "ams-001",
        title: "رخام صناعي (ألواح) - أبيض سادة",
        badge: "ألواح",
      ...
      {
        id: "ams-002",
        title: "مغسلة رخام صناعي - مقاس جاهز",
        badge: "مغاسل",
        price: "السعر عند الطلب",
        size: "60×45",
        finish: "لامع",
          ...
          <div className="luxHeroCopy">
            ...
            <div className="luxHeroStats">
              <div className="luxStat">
                <div className="luxStatNum">تفصيل</div>
                <div className="luxStatLabel">حسب المقاس</div>
              </div>
              <div className="luxStat">
                <div className="luxStatNum">سنجل/دبل</div>
                <div className="luxStatLabel">فتحات الحوض</div>
              </div>
              <div className="luxStat">
              ...
              <div className="luxModalSide">
                ...
                <div className="luxModalInfo">
                  ...
                  <div className="luxHint">
                    * ابعت المقاسات/صورة المكان على واتساب عشان نديك تسعير أدق.
                  </div>
                </div>
              </div>
            </div>
